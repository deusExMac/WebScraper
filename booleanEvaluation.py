#
# From here: https://stackoverflow.com/questions/2467590/dynamically-evaluating-simple-boolean-logic-in-python
#
# Evaluates boolean infix expressions i.e. A and B or C
#
...
def evaluateBooleanExpressionList( bExpList ):
    ...
    try:
         ...
         return( eval(strBExp) )
           ...
           print('[WARNING] Error during evaluation of boolean expression [', bExpList,'] (', str(eEx), ')', sep='' )
